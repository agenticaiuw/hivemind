...
export function createD1Store(db) {
  ...
  return {
    ...
    /*
     * No cross-surface memory-event log anymore (the relay_memory_events
     * table stays in the schema, empty; dropping tables is a different
     * change). Domain memory lives in the fleet state's domainMemory hive
     * block and rides getState/saveState, merged on write by the relay —
     * see cloud-relay/domainMemoryRelay.js.
     */
  }
}
